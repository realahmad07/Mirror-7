...
def build_model(config: ModelConfig):
    ...
    class ByteGRULanguageModel(nn.Module):
        ...
        def generate(self, prefix, *, max_new_bytes=768, temperature=0.8, top_k=40):
            ...
            # Prime the recurrent state with the full prompt and use the prompt's
            # final logits for the first generated byte. Avoid feeding RESPONSE twice.
            logits, hidden = self(prefix)
