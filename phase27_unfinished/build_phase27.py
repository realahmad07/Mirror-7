...
# The generated compiler must expose the executable helper used by acceptance tests.
# Keep it deliberately simple: the status cell is initialized by compile-structured,
# and a failed compilation cannot yield a valid alpha definition for word-exec.
w=Wd('run-alpha'); w.t('create-pass','compile-structured','97','64','!','108','65','!','112','66','!','104','67','!','97','68','!','5','12','!','find-word','19','!','18','!','18','@','19','@','word-exec','exit')
cur=start
for w in words:
