...
PRIM_BYTES=2*len(PRIMS); BASE_PRIM_BYTES=48; PRIM_DELTA=PRIM_BYTES-BASE_PRIM_BYTES
if PRIM_DELTA:
    fixed=[]
    for line in base_lines:
        ...
        for t in line.split():
            ...
            if m:t=m.group(1)+str(int(m.group(2))+PRIM_DELTA)
            out.append(t)
...
for i,line in enumerate(base_lines):
    ...
    raise SystemExit('create-pass not found in Phase 26 compiler')
shifted=[]
for line in base_lines:
    out=[]
    for t in line.split():
