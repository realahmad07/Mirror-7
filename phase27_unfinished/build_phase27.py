...
# Acceptance helper: compile exactly once, then execute the last-created source word.
# This avoids a second lexical lookup after the compiler has consumed the input.
w=Wd('run-alpha'); w.t('compile-structured','word-count','19','!','18','!','1','18','@','-','18','!','18','@','19','@','word-exec','exit')
cur=start
for w in words:
